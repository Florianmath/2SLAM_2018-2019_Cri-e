...
<p> <i>Les données peuvent prendre quelques secondes à s'implanter, veuillez patientez entre chaque saisies.</i> </p><br/>
...
<form method="post" action="<?php echo site_url ('utilisateur/enregistreLot'); ?>"><br/>
	<p>
	 <!-- Enregistrer un lot :
		<br/><br>
	  ...
	  //  }?>-->
		...
		<input type="date" name="dateEnchere"/> &nbsp &nbsp<br>

		<label for="dateHeureFin">Date de fin : </label>
		<input type="date" name="dateHeureFin"/> &nbsp &nbsp<br><br>
